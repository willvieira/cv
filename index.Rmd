...
· Developed and maintained the [QCBS R Workshop Series](https://r.qcbs.ca/), teaching R and statistics to nearly one thousand graduate students · Taught statistics, probability, and scientific programming to 250+ students across biology, engineering, and graduate programs · Published [5 papers & preprints](https://scholar.google.com/citations?user=GyChlIoAAAAJ&hl=en) with ~100 citations · Translated statistical methods into clear explanations and reproducible analyses for non-specialist audiences

...
A list of my publications can be found [here](https://scholar.google.com/citations?user=GyChlIoAAAAJ&hl=pt-BR). In this [talk](https://willvieira.github.io/talk_biodiversityModeling2019/#1) I present the R package from my model, and this [talk](https://willvieira.github.io/talk_STM-QCBS2018/#1) I present the results. [Here](https://doc.ielab.usherbrooke.ca/index.php/s/mLZetyMpl2Jdc0g) and [here](https://doc.ielab.usherbrooke.ca/index.php/s/1CEtQkOasDS1MSQ) are two selected posters.
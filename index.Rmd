...
<span style="font-weight:600;">Machine Learning & Modelling</span>: <br>
Forecasting · Bayesian inference · Hierarchical models · Causal inference · A/B testing · Experimental design · Forecast evaluation · Uncertainty

<span style="font-weight:600;">Programming & Database</span>: <br>
R · Python · SQL · Stan · Julia · DuckDB · Bash

<span style="font-weight:600;">Data Engineering & Cloud</span>: <br>
ETL/ELT · Production ML pipelines · Feature engineering · Azure · AWS · Docker · Apache Arrow · Parquet · HPC

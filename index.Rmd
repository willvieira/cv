...
Bayesian inference · Hierarchical models · Model evaluation · Error analysis · Uncertainty quantification · Forecasting · Feature engineering · Calibration

<span style="font-weight:600;">Programming & Database</span>: <br>
Python · R · SQL · PyTorch · Stan · DuckDB · Bash

<span style="font-weight:600;">Data Engineering & Cloud</span>: <br>
ETL/ELT · Production ML pipelines · Docker · Azure · AWS · Apache Arrow · HPC

<span style="font-weight:600;">DevOps & Reproducibility</span>: <br>
Git · CI/CD · Unix · Unit testing · Reproducible pipelines · Automated validation · Make · Jupyter
...
· Developed and maintained the [QCBS R Workshop Series](https://r.qcbs.ca/), reaching nearly one thousand graduate students · Taught programming, statistics, and ecology to 250+ students across biology, engineering, and graduate programs · Published [5 papers & preprints](https://scholar.google.com/citations?user=GyChlIoAAAAJ&hl=en) with ~100 citations · Translated stakeholder needs into technical analyses, reproducible workflows, and clear analytical outputs
...
<p style="text-align:justify;margin-top: 4px; margin-bottom: 0;">
  Data scientist and ML engineer with a PhD in quantitative ecology. I build reproducible machine learning pipelines on noisy, real-world data — from Bayesian and ML modelling to the production infrastructure that makes models traceable, monitored, and safe to deploy.
</p>
